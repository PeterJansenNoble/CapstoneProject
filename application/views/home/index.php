...
<body>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <p class="mb-4 pb-0">Barangay 386 | Quiapo Manila</p>
      <p> Report any incidents that are troubling and that can harm the environment for a better environment.
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6">
            <h2>About</h2>
            <p>The main goal of this study was to create BIMS that would enable the barangay to effectively implement peace and order in their barangay by enabling them to monitor and observe the status of complaints made in their barangay.</p>
          </div>
          <div class="col-lg-3">
            <h3>Where</h3>
            <p>Barangay 386 | Quiapo Manila</p>
          </div>
          <div class="col-lg-3">
            <h3>Contact</h3>
            <p>09213981287<br>brgy386@gmail.com</p>
          </div>
        </div>
      </div>
